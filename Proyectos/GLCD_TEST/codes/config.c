...
void Cfg_Led(){
	...
	// Configuracion del pin (LED1) como GPIO, con con pull-down y pull-up Deshabilitados
...
// **********************************************************************
//                Función Configuración Pines Display Gráfico
// **********************************************************************

void Cfg_PinesDisplayGrafico(){

	// Configuracion de pines como GPIO para el Bus de Datos, con pull-down y pull-up Deshabilitados
	SCU->SFSP[6][1] = (SCU_MODE_DES | SCU_MODE_FUNC0);// P6_1, GPIO3[0]  ->
	SCU->SFSP[4][4] = (SCU_MODE_DES | SCU_MODE_FUNC0);// P4_4, GPIO2[4]  -> Se utilizo LCD1 porque hay un problema con GPIO1, ya que siempre permanece a 1.
	SCU->SFSP[6][5] = (SCU_MODE_DES | SCU_MODE_FUNC0);// P6_5, GPIO3[4]  -> 
	SCU->SFSP[6][7] = (SCU_MODE_DES | SCU_MODE_FUNC4);// P6_7, GPIO5[15] -> 
	SCU->SFSP[6][8] = (SCU_MODE_DES | SCU_MODE_FUNC4);// P6_8, GPIO5[16] -> 
	SCU->SFSP[6][9] = (SCU_MODE_DES | SCU_MODE_FUNC0);// P6_9, GPIO3[5]  -> 
	SCU->SFSP[6][10] = (SCU_MODE_DES | SCU_MODE_FUNC0);// P6_10, GPIO3[6]  -> 
	SCU->SFSP[6][11] = (SCU_MODE_DES | SCU_MODE_FUNC0);// P6_11, GPIO3[7]  -> 
	SCU->SFSP[6][12] = (SCU_MODE_DES | SCU_MODE_FUNC0);// P6_12, GPIO2[8]  -> 
	SCU->SFSP[4][0] = (SCU_MODE_DES | SCU_MODE_FUNC0);// P4_0, GPIO2[0]  -> 
	SCU->SFSP[4][1] = (SCU_MODE_DES | SCU_MODE_FUNC0);// P4_1, GPIO2[1]  -> 
	SCU->SFSP[4][2] = (SCU_MODE_DES | SCU_MODE_FUNC0);// P4_2, GPIO2[2]  -> 
	SCU->SFSP[4][3] = (SCU_MODE_DES | SCU_MODE_FUNC0);// P4_3, GPIO2[3]  -> 
	SCU->SFSP[1][5] = (SCU_MODE_DES | SCU_MODE_FUNC0);// P1_5, GPIO1[8]  -> 
	SCU->SFSP[7][4] = (SCU_MODE_DES | SCU_MODE_FUNC0);// P7_4, GPIO3[12]  -> 
	SCU->SFSP[7][5] = (SCU_MODE_DES | SCU_MODE_FUNC0);// P7_5, GPIO3[13]  -> 

	// Configuracion de pines como GPIO para RS, WR, RD, RESET y CS con pull-down y pull-up Deshabilitados
	SCU->SFSP[4][5] = (SCU_MODE_DES | SCU_MODE_FUNC0);// P4_5, GPIO2[5]  -> RS
	SCU->SFSP[4][6] = (SCU_MODE_DES | SCU_MODE_FUNC0);// P4_6, GPIO2[6]  -> WR
	SCU->SFSP[4][10] = (SCU_MODE_DES | SCU_MODE_FUNC4);// P4_10, GPIO5[14]  -> RD
	SCU->SFSP[4][8] = (SCU_MODE_DES | SCU_MODE_FUNC4);// P4_8, GPIO5[12]  -> RESET
	SCU->SFSP[4][9] = (SCU_MODE_DES | SCU_MODE_FUNC4);// P4_9, GPIO5[13]  -> CS
	...
	GPIO_PORT->DIR[2] |= 1 << 3;
	GPIO_PORT->DIR[1] |= 1 << 8;
	GPIO_PORT->DIR[3] |= 1 << 12;
	GPIO_PORT->DIR[3] |= 1 << 13;

	GPIO_PORT->DIR[2] |= 1 << 5;
	GPIO_PORT->DIR[2] |= 1 << 6;
	GPIO_PORT->DIR[5] |= 1 << 14;
	GPIO_PORT->DIR[5] |= 1 << 12;
	GPIO_PORT->DIR[5] |= 1 << 13;

	// Todas las salidas en 0v
	...
	Chip_GPIO_ClearValue(LPC_GPIO_PORT, 3,(1<<13));
