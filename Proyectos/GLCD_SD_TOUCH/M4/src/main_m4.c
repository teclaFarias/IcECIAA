...
//	anchoPulso= (int)(anchoPulso*255)/100;
		sprintf_mio(aux,"\nValor ALTO: %d  valor BAJO: %d  dutyCycle: %d \n", acumuladorEstadoAlto, acumuladorEstadoBajo, anchoPulso );
		mensaje(&aux);
...
int main(void){
	...
	mensaje("\nCargando datos de entrenamiento en memoria...");
	cargarArrayTraining();
	mensaje("  Ok\n");
